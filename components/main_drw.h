...
extern Drw* drw_create(Display* dpy, int screen, Window win, unsigned int w,
                       unsigned int h);
...
extern unsigned int drw_fontset_getwidth_clamp(Drw* drw, const char* text,
                                               unsigned int n);
extern void drw_font_getexts(Fnt* font, const char* text, unsigned int len,
                             unsigned int* w, unsigned int* h);

/* Colorscheme abstraction */
extern void drw_clr_create(Drw* drw, Clr* dest, const char* clrname);
extern Clr* drw_scm_create(Drw* drw, const char* clrnames[], size_t clrcount);
...
/* Drawing functions */
extern void drw_rect(Drw* drw, int x, int y, unsigned int w, unsigned int h,
                     int filled, int invert);
extern int drw_text(Drw* drw, int x, int y, unsigned int w, unsigned int h,
