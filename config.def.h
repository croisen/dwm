#ifndef ___DWM_6_4_CONFIG_DEF_H___
#define ___DWM_6_4_CONFIG_DEF_H___

#include "../dwm.h"
#include "enums.h"
#include "patch_comps/awesome_bar.h"
#include "u_structs.h"
...
const unsigned int gappx    = 1;  /* gap pixel between windows */
